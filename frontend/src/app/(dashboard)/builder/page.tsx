  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
      <div className="w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center border border-accent/20">
        <Hammer className="w-8 h-8 text-accent animate-pulse" />
      </div>
      <div className="space-y-2 max-w-md">
        ...
        <p className="text-sm text-text-secondary">
          An interactive playground to select contexts, compile templates, view variable resolutions, and test prompts against configured models.
        </p>
      </div>
    </div>
  );
